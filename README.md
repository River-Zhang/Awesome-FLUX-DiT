...
> Last Update: 2025-05-28 06:33:54
...
- [Image Generation](#image-generation) (181 papers) - Papers focusing on image generation with Diffusion Transformer or FLUX
- [Video Related](#video-related) (122 papers) - Papers about video generation and editing with Diffusion Transformer or FLUX
...
- **[Lay-Your-Scene: Natural Scene Layout Generation with Diffusion Transformers](https://arxiv.org/abs/2505.04718v1)** (Published: 2025-05-07)  
  ...
  Keywords: image editing, image generation, diffusion transformer, Controllable, Control  
...
- **[X2I: Seamless Integration of Multimodal Understanding into Diffusion Transformer via Attention Distillation](https://arxiv.org/abs/2503.06134v2)** (Published: 2025-03-08)  
  ...
  Keywords: image editing, text-to-image, image generation, diffusion transformer, Control, image to image  
...
- **[AMO Sampler: Enhancing Text Rendering with Overshooting](https://arxiv.org/abs/2411.19415v2)** (Published: 2024-11-28)  
  ...
  Keywords: text-to-image, image generation, rectified flow, Control, FLUX  
...
- **[Oscillation Inversion: Understand the structure of Large Flow Model through the Lens of Inversion Method](https://arxiv.org/abs/2411.11135v1)** (Published: 2024-11-17)  
  ...
  Keywords: image editing, text-to-image, inversion, rectified flow, FLUX  
...
- **[Taming Rectified Flow for Inversion and Editing](https://arxiv.org/abs/2411.04746v2)** (Published: 2024-11-07)  
  ...
  Keywords: video generation, inversion, rectified flow, diffusion transformer, video editing, FLUX  
...
- **[PixWizard: Versatile Image-to-Image Visual Assistant with Open-Language Instructions](https://arxiv.org/abs/2409.15278v4)** (Published: 2024-09-23)  
  ...
  Keywords: image editing, text-to-image, image generation, diffusion transformer, Controllable, Control  
- **[Latent Space Disentanglement in Diffusion Transformers Enables Zero-shot Fine-grained Semantic Editing](https://arxiv.org/abs/2408.13335v1)** (Published: 2024-08-23)  
  ...
  Keywords: text-to-image, diffusion transformer, image editing, Control  
...
- **[MMIG-Bench: Towards Comprehensive and Explainable Evaluation of Multi-Modal Image Generation Models](https://arxiv.org/abs/2505.19415v1)** (Published: 2025-05-26)  
  Authors: Hang Hua, Ziyun Zeng, Yizhi Song, Yunlong Tang, Liu He, Daniel Aliaga, Wei Xiong, Jiebo Luo  
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2505.19415v1.pdf)  
...
- **[Frame In-N-Out: Unbounded Controllable Image-to-Video Generation](https://arxiv.org/abs/2505.21491v1)** (Published: 2025-05-27)  
  ...
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2505.21491v1.pdf)  
  Keywords: diffusion transformer, video generation, Control, Controllable  
- **[Minute-Long Videos with Dual Parallelisms](https://arxiv.org/abs/2505.21070v1)** (Published: 2025-05-27)  
  Authors: Zeqing Wang, Bowen Zheng, Xingyi Yang, Yuecong Xu, Xinchao Wang  
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2505.21070v1.pdf)  
...
- **[RelaCtrl: Relevance-Guided Efficient Control for Diffusion Transformers](https://arxiv.org/abs/2502.14377v4)** (Published: 2025-02-20)  
  ...
  Keywords: video generation, text-to-image, diffusion transformer, Controllable, Control  
