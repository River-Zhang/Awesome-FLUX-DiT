...
> Last Update: 2025-05-27 06:33:54
...
- [Image Generation](#image-generation) (179 papers) - Papers focusing on image generation with Diffusion Transformer or FLUX
- [Video Related](#video-related) (119 papers) - Papers about video generation and editing with Diffusion Transformer or FLUX
...
- **[Lay-Your-Scene: Natural Scene Layout Generation with Diffusion Transformers](https://arxiv.org/abs/2505.04718v1)** (Published: 2025-05-07)  
  ...
  Keywords: Controllable, image generation, Control, diffusion transformer, image editing  
...
- **[Detection Limits and Statistical Separability of Tree Ring Watermarks in Rectified Flow-based Text-to-Image Generation Models](https://arxiv.org/abs/2504.03850v1)** (Published: 2025-04-04)  
  ...
  Keywords: inversion, image generation, rectified flow, FLUX, text-to-image  
...
- **[X2I: Seamless Integration of Multimodal Understanding into Diffusion Transformer via Attention Distillation](https://arxiv.org/abs/2503.06134v2)** (Published: 2025-03-08)  
  ...
  Keywords: image generation, image to image, Control, diffusion transformer, image editing, text-to-image  
...
- **[Taming Rectified Flow for Inversion and Editing](https://arxiv.org/abs/2411.04746v2)** (Published: 2024-11-07)  
  ...
  Keywords: inversion, rectified flow, FLUX, video generation, video editing, diffusion transformer  
- **[DiT4Edit: Diffusion Transformer for Image Editing](https://arxiv.org/abs/2411.03286v2)** (Published: 2024-11-05)  
  ...
  Keywords: inversion, image generation, Control, diffusion transformer, image editing  
...
- **[PixWizard: Versatile Image-to-Image Visual Assistant with Open-Language Instructions](https://arxiv.org/abs/2409.15278v4)** (Published: 2024-09-23)  
  ...
  Keywords: Controllable, image generation, Control, diffusion transformer, image editing, text-to-image  
...
- **[Dynamic-I2V: Exploring Image-to-Video Generaion Models via Multimodal LLM](https://arxiv.org/abs/2505.19901v1)** (Published: 2025-05-26)  
  Authors: Peng Liu, Xiaoming Ren, Fengkai Liu, Qingsong Xie, Quanlong Zheng, Yanhao Zhang, Haonan Lu, Yujiu Yang  
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2505.19901v1.pdf)  
...
- **[Acquire and then Adapt: Squeezing out Text-to-Image Model for Image Restoration](https://arxiv.org/abs/2504.15159v1)** (Published: 2025-04-21)  
  ...
  Keywords: image generation, FLUX, Control, diffusion transformer, text-to-image  
...
- **[RelaCtrl: Relevance-Guided Efficient Control for Diffusion Transformers](https://arxiv.org/abs/2502.14377v4)** (Published: 2025-02-20)  
  ...
  Keywords: Controllable, video generation, Control, diffusion transformer, text-to-image  
