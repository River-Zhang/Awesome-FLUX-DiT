...
> Last Update: 2025-02-27 06:29:53
...
- [Image Generation](#image-generation) (110 papers) - Papers focusing on image generation with Diffusion Transformer or FLUX
- [Video Related](#video-related) (77 papers) - Papers about video generation and editing with Diffusion Transformer or FLUX
...
- **[Taming Rectified Flow for Inversion and Editing](https://arxiv.org/abs/2411.04746v2)** (Published: 2024-11-07)  
  ...
  Keywords: video editing, video generation, diffusion transformer, rectified flow, inversion, FLUX  
...
- **[PixWizard: Versatile Image-to-Image Visual Assistant with Open-Language Instructions](https://arxiv.org/abs/2409.15278v3)** (Published: 2024-09-23)  
  ...
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2409.15278v3.pdf) | [![GitHub](https://img.shields.io/github/stars/AFeng-x/PixWizard?style=social)](https://github.com/AFeng-x/PixWizard)  
  Keywords: Control, Controllable, image editing, diffusion transformer, image generation, text-to-image  
...
- **[RelaCtrl: Relevance-Guided Efficient Control for Diffusion Transformers](https://arxiv.org/abs/2502.14377v2)** (Published: 2025-02-20)  
  ...
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2502.14377v2.pdf)  
  Keywords: Control, Controllable, video generation, diffusion transformer, text-to-image  
- **[AnyRefill: A Unified, Data-Efficient Framework for Left-Prompt-Guided Vision Tasks](https://arxiv.org/abs/2502.11158v2)** (Published: 2025-02-16)  
  Authors: Ming Xie, Chenjie Cao, Yunuo Cai, Xiangyang Xue, Yu-Gang Jiang, Yanwei Fu  
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2502.11158v2.pdf)  
  Keywords: diffusion transformer, text-to-image, image editing  
...
- **[3DIS-FLUX: simple and efficient multi-instance generation with DiT rendering](https://arxiv.org/abs/2501.05131v1)** (Published: 2025-01-09)  
  ...
  Keywords: Control, Controllable, image generation, text-to-image, FLUX  
...
- **[Open-Sora: Democratizing Efficient Video Production for All](https://arxiv.org/abs/2412.20404v1)** (Published: 2024-12-29)  
  ...
  Keywords: video generation, diffusion transformer, image generation, text-to-image  
...
- **[FlexDiT: Dynamic Token Density Control for Diffusion Transformer](https://arxiv.org/abs/2412.06028v1)** (Published: 2024-12-08)  
  ...
  Keywords: Control, video generation, diffusion transformer, image generation, text-to-image  
...
- **[Self-Guidance: Boosting Flow and Diffusion Generation on Their Own](https://arxiv.org/abs/2412.05827v1)** (Published: 2024-12-08)  
  ...
  Keywords: video generation, diffusion transformer, image generation, text-to-image, FLUX  
...
- **[World-consistent Video Diffusion with Explicit 3D Modeling](https://arxiv.org/abs/2412.01821v1)** (Published: 2024-12-02)  
  ...
  Keywords: video generation, Control, diffusion transformer, image generation  
