...
> Last Update: 2024-12-09 15:51:06

## Categories

- [Image Editing](#image-editing) (12 papers) - Papers about image editing with Diffusion Transformer or FLUX
- [Image Generation](#image-generation) (75 papers) - Papers focusing on image generation with Diffusion Transformer or FLUX
...
- **[Oscillation Inversion: Understand the structure of Large Flow Model through the Lens of Inversion Method](https://arxiv.org/abs/2411.11135v1)** (Published: 2024-11-17)  
  ...
  Keywords: rectified flow, FLUX, image editing, text-to-image  
...
- **[Semantic Image Inversion and Editing using Rectified Stochastic Differential Equations](https://arxiv.org/abs/2410.10792v1)** (Published: 2024-10-14)  
  ...
  Keywords: rectified flow, FLUX, image editing, Control  
...
- **[PixWizard: Versatile Image-to-Image Visual Assistant with Open-Language Instructions](https://arxiv.org/abs/2409.15278v2)** (Published: 2024-09-23)  
  ...
  Keywords: image generation, diffusion transformer, text-to-image, image editing, Control, Controllable  
...
- **[Lightning-Fast Image Inversion and Editing for Text-to-Image Diffusion Models](https://arxiv.org/abs/2312.12540v4)** (Published: 2023-12-19)  
  ...
  Keywords: FLUX, image editing, text-to-image  
...
- **[Seeing Beyond Views: Multi-View Driving Scene Video Generation with Holistic Attention](https://arxiv.org/abs/2412.03520v1)** (Published: 2024-12-04)  
  ...
  Keywords: Control, video generation, diffusion transformer, ControlNet  
...
- **[AMO Sampler: Enhancing Text Rendering with Overshooting](https://arxiv.org/abs/2411.19415v1)** (Published: 2024-11-28)  
  ...
  Keywords: FLUX, image generation, text-to-image, rectified flow, Control  
...
- **[DiVE: DiT-based Video Generation with Enhanced Control](https://arxiv.org/abs/2409.01595v1)** (Published: 2024-09-03)  
  ...
  Keywords: video generation, diffusion transformer, Control, Controllable, ControlNet  
...
- **[VD3D: Taming Large Video Diffusion Transformers for 3D Camera Control](https://arxiv.org/abs/2407.12781v2)** (Published: 2024-07-17)  
  ...
  Keywords: video generation, diffusion transformer, Control, Controllable, ControlNet  
- **[Scaling Diffusion Transformers to 16 Billion Parameters](https://arxiv.org/abs/2407.11633v3)** (Published: 2024-07-16)  
  Authors: Zhengcong Fei, Mingyuan Fan, Changqian Yu, Debang Li, Junshi Huang  
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2407.11633v3.pdf) | [![GitHub](https://img.shields.io/github/stars/feizc/DiT-MoE?style=social)](https://github.com/feizc/DiT-MoE)  
  Keywords: image generation, diffusion transformer  
- **[Exploring the Role of Large Language Models in Prompt Encoding for Diffusion Models](https://arxiv.org/abs/2406.11831v3)** (Published: 2024-06-17)  
  Authors: Bingqi Ma, Zhuofan Zong, Guanglu Song, Hongsheng Li, Yu Liu  
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2406.11831v3.pdf)  
  Keywords: image generation, diffusion transformer, text-to-image  
- **[An Analysis on Quantizing Diffusion Transformers](https://arxiv.org/abs/2406.11100v1)** (Published: 2024-06-16)  
  Authors: Yuewei Yang, Jialiang Wang, Xiaoliang Dai, Peizhao Zhang, Hongbo Zhang  
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2406.11100v1.pdf)  
  Keywords: image generation, diffusion transformer  
...
- **[Taming Rectified Flow for Inversion and Editing](https://arxiv.org/abs/2411.04746v2)** (Published: 2024-11-07)  
  ...
  Keywords: video generation, FLUX, video editing, diffusion transformer, rectified flow  
- **[Adaptive Caching for Faster Video Generation with Diffusion Transformers](https://arxiv.org/abs/2411.02397v2)** (Published: 2024-11-04)  
  Authors: Kumara Kahatapitiya, Haozhe Liu, Sen He, Ding Liu, Menglin Jia, Chenyang Zhang, Michael S. Ryoo, Tian Xie  
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2411.02397v2.pdf)  
  Keywords: Control, video generation, diffusion transformer  
