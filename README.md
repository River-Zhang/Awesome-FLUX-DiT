...
> Last Update: 2025-02-21 06:29:24
...
- [Video Related](#video-related) (75 papers) - Papers about video generation and editing with Diffusion Transformer or FLUX
...
- **[EliGen: Entity-Level Controlled Image Generation with Regional Attention](https://arxiv.org/abs/2501.01097v3)** (Published: 2025-01-02)  
  ...
  Keywords: Control, image inpainting, diffusion transformer, text-to-image, image generation  
...
- **[FluxSpace: Disentangled Semantic Editing in Rectified Flow Transformers](https://arxiv.org/abs/2412.09611v1)** (Published: 2024-12-12)  
  ...
  Keywords: Control, rectified flow, FLUX, image generation, image editing  
...
- **[Oscillation Inversion: Understand the structure of Large Flow Model through the Lens of Inversion Method](https://arxiv.org/abs/2411.11135v1)** (Published: 2024-11-17)  
  ...
  Keywords: text-to-image, FLUX, rectified flow, inversion, image editing  
...
- **[Taming Rectified Flow for Inversion and Editing](https://arxiv.org/abs/2411.04746v2)** (Published: 2024-11-07)  
  ...
  Keywords: diffusion transformer, video generation, video editing, FLUX, rectified flow, inversion  
...
- **[PixWizard: Versatile Image-to-Image Visual Assistant with Open-Language Instructions](https://arxiv.org/abs/2409.15278v2)** (Published: 2024-09-23)  
  ...
  Keywords: Control, diffusion transformer, Controllable, text-to-image, image generation, image editing  
...
- **[RelaCtrl: Relevance-Guided Efficient Control for Diffusion Transformers](https://arxiv.org/abs/2502.14377v1)** (Published: 2025-02-20)  
  ...
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2502.14377v1.pdf) | [![Project](https://img.shields.io/badge/-Project-blue)](https://relactrl.github.io/RelaCtrl/.)  
  Keywords: Control, diffusion transformer, video generation, Controllable, text-to-image  
- **[AnyRefill: A Unified, Data-Efficient Framework for Left-Prompt-Guided Vision Tasks](https://arxiv.org/abs/2502.11158v2)** (Published: 2025-02-16)  
  Authors: Ming Xie, Chenjie Cao, Yunuo Cai, Xiangyang Xue, Yu-Gang Jiang, Yanwei Fu  
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2502.11158v2.pdf)  
  Keywords: text-to-image, diffusion transformer, image editing  
...
- **[3DIS-FLUX: simple and efficient multi-instance generation with DiT rendering](https://arxiv.org/abs/2501.05131v1)** (Published: 2025-01-09)  
  ...
  Keywords: Control, Controllable, text-to-image, FLUX, image generation  
...
- **[FlexDiT: Dynamic Token Density Control for Diffusion Transformer](https://arxiv.org/abs/2412.06028v1)** (Published: 2024-12-08)  
  ...
  Keywords: Control, diffusion transformer, video generation, text-to-image, image generation  
