...
> Last Update: 2025-02-05 06:28:28
...
- **[Oscillation Inversion: Understand the structure of Large Flow Model through the Lens of Inversion Method](https://arxiv.org/abs/2411.11135v1)** (Published: 2024-11-17)  
  ...
  Keywords: text-to-image, image editing, rectified flow, FLUX, inversion  
...
- **[PixWizard: Versatile Image-to-Image Visual Assistant with Open-Language Instructions](https://arxiv.org/abs/2409.15278v2)** (Published: 2024-09-23)  
  ...
  Keywords: Controllable, diffusion transformer, text-to-image, image editing, Control, image generation  
...
- **[MakeAnything: Harnessing Diffusion Transformers for Multi-Domain Procedural Sequence Generation](https://arxiv.org/abs/2502.01572v1)** (Published: 2025-02-03)  
  Authors: Yiren Song, Cheng Liu, Mike Zheng Shou  
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2502.01572v1.pdf)  
...
- **[FlexDiT: Dynamic Token Density Control for Diffusion Transformer](https://arxiv.org/abs/2412.06028v1)** (Published: 2024-12-08)  
  ...
  Keywords: diffusion transformer, text-to-image, video generation, Control, image generation  
...
- **[Self-Guidance: Boosting Flow and Diffusion Generation on Their Own](https://arxiv.org/abs/2412.05827v1)** (Published: 2024-12-08)  
  ...
  Keywords: diffusion transformer, text-to-image, video generation, image generation, FLUX  
