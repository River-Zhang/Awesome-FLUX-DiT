...
> Last Update: 2024-12-17 06:31:43
...
- [Image Generation](#image-generation) (85 papers) - Papers focusing on image generation with Diffusion Transformer or FLUX
...
- **[FluxSpace: Disentangled Semantic Editing in Rectified Flow Transformers](https://arxiv.org/abs/2412.09611v1)** (Published: 2024-12-12)  
  ...
  Keywords: image editing, Control, FLUX, image generation, rectified flow  
...
- **[Taming Rectified Flow for Inversion and Editing](https://arxiv.org/abs/2411.04746v2)** (Published: 2024-11-07)  
  ...
  Keywords: FLUX, video generation, inversion, video editing, rectified flow, diffusion transformer  
...
- **[PixWizard: Versatile Image-to-Image Visual Assistant with Open-Language Instructions](https://arxiv.org/abs/2409.15278v2)** (Published: 2024-09-23)  
  ...
  Keywords: image editing, Control, Controllable, image generation, diffusion transformer, text-to-image  
...
- **[Causal Diffusion Transformers for Generative Modeling](https://arxiv.org/abs/2412.12095v1)** (Published: 2024-12-16)  
  Authors: Chaorui Deng, Deyao Zh, Kunchang Li, Shi Guan, Haoqi Fan  
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2412.12095v1.pdf)  
  Keywords: image generation, diffusion transformer  
- **[Video Diffusion Transformers are In-Context Learners](https://arxiv.org/abs/2412.10783v1)** (Published: 2024-12-14)  
  Authors: Zhengcong Fei, Di Qiu, Changqian Yu, Debang Li, Mingyuan Fan, Xiang Wen  
  Links: [![PDF](https://img.shields.io/badge/PDF-arXiv-b31b1b.svg)](https://arxiv.org/pdf/2412.10783v1.pdf) | [![GitHub](https://img.shields.io/github/stars/feizc/Video-In-Context?style=social)](https://github.com/feizc/Video-In-Context)  
...
- **[FlexDiT: Dynamic Token Density Control for Diffusion Transformer](https://arxiv.org/abs/2412.06028v1)** (Published: 2024-12-08)  
  ...
  Keywords: Control, video generation, image generation, diffusion transformer, text-to-image  
...
- **[Training-free Regional Prompting for Diffusion Transformers](https://arxiv.org/abs/2411.02395v1)** (Published: 2024-11-04)  
  ...
  Keywords: image generation, FLUX, diffusion transformer, text-to-image  
